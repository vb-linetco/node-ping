 ...
 *                                          Default: false
 * If enabled and a reply is received from address which does not match the parsed
 * numeric_host then the timing information is discarded, which results in a host not
 * being considered as alive. If not enabled, no verification is done
